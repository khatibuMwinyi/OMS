...
export default async function ReceiptCategoriesPage({ searchParams }: PageProps) {
  ...
  const nextCode = isEditing
    ? editCategory?.code ?? ""
    : await getNextCategoryCode("receipt");

  return (
    <main className="dashboard-shell">
      <AppHeader session={session} activeHref="/admin/categories/receipts" />

      <div className="dashboard-content">
        <section className="page-hero">
          <div>
            <span className="eyebrow">Administration</span>
            <h1 className="page-title">Receipt Categories</h1>
            <p className="subtle-copy">
              Manage revenue categories for receipt transactions.
            </p>
          </div>
        </section>
            ...
            >
              ...
              <div className="form-field">
                ...
                <Input
                  ...
                  placeholder="e.g., Oweru Products"
                  required
                  className="w-full"
                />
              </div>
              <div className="form-field">
                ...
                <Input
                  name="type"
                  defaultValue={editCategory?.type ?? "Revenue"}
                  readOnly
                  className="w-full"
                />
              </div>
              ...
              <div className="form-actions">
                ...
                {isEditing ? (
                  <a href="/admin/categories/receipts" className="btn btn-outline">
                    Cancel
                  </a>
                ) : null}
              </div>
          ...
          <section className="category-list-card">
            <div className="section-head">
              <div>
                ...
                <h2 className="section-title">Receipt Categories</h2>
              </div>
            </div>

            <CategoryFilterTable
              categories={categories}
              basePath="/admin/categories/receipts"
              module="receipt"
