...
export default async function PettyCashCategoriesPage({ searchParams }: PageProps) {
  ...
  const nextCode = isEditing
    ? editCategory?.code ?? ""
    : await getNextCategoryCode("petty_cash");

  return (
    <main className="dashboard-shell">
      <AppHeader session={session} activeHref="/admin/categories/petty-cash" />

      <div className="dashboard-content">
        <section className="page-hero">
          <div>
            <span className="eyebrow">Administration</span>
            <h1 className="page-title">Petty Cash Categories</h1>
            <p className="subtle-copy">
              Manage expense categories for petty cash transactions.
            </p>
          </div>
        </section>
            ...
            >
              ...
              <div className="form-field">
                ...
                <Input
                  ...
                  placeholder="e.g., Petty Cash - Office Operations"
                  required
                  className="w-full"
                />
              </div>
              ...
              <div className="form-actions">
                ...
                {isEditing ? (
                  <a href="/admin/categories/petty-cash" className="btn btn-outline">
                    Cancel
                  </a>
                ) : null}
              </div>
          ...
          <section className="category-list-card">
            <div className="section-head">
              <div>
                ...
                <h2 className="section-title">Petty Cash Categories</h2>
              </div>
            </div>

            <CategoryFilterTable
              categories={categories}
              basePath="/admin/categories/petty-cash"
              module="petty_cash"
