...
export const legacyReceiptRecords: LegacySelectionRecord[] = [
  ...
  { type: "Revenue", category: "Oweru Investment", code: "RC-401", description: "Local Investor Facilitation Fees" },
...
export const legacyVoucherRecords: LegacySelectionRecord[] = [
  { type: "Expense", category: "Office & Administration", code: "EC-701", description: "Office Rent" },
  { type: "Expense", category: "Office & Administration", code: "EC-702", description: "Office Supplies / Stationery" },
  { type: "Expense", category: "Office & Administration", code: "EC-703", description: "Office Equipment Purchase" },
  { type: "Expense", category: "Office & Administration", code: "EC-704", description: "Office Furniture" },
  { type: "Expense", category: "Office & Administration", code: "EC-705", description: "Decoration, Office Branding & Tools" },
  { type: "Expense", category: "Office & Administration", code: "EC-706", description: "Utensils (Kitchen/Office)" },
  { type: "Expense", category: "Office & Administration", code: "EC-711", description: "Utilities (Electricity, Water, Internet)" },
  { type: "Expense", category: "Office & Administration", code: "EC-712", description: "Equipment Maintenance & Repairs" },
  { type: "Expense", category: "Office & Administration", code: "EC-713", description: "Communication Costs" },
  { type: "Expense", category: "Finance", code: "EC-801", description: "Bank Charges & Transaction Fees" },
  { type: "Expense", category: "Finance", code: "EC-802", description: "Loan Interest Expense" },
  { type: "Expense", category: "Finance", code: "EC-803", description: "Discounts Allowed" },
  { type: "Expense", category: "Staff & HR", code: "EC-901", description: "Staff Salaries" },
  { type: "Expense", category: "Staff & HR", code: "EC-902", description: "NSSF / PPF Contributions" },
  { type: "Expense", category: "Staff & HR", code: "EC-903", description: "WCF Contributions" },
  { type: "Expense", category: "Staff & HR", code: "EC-904", description: "Staff Allowances / Bonus" },
  { type: "Expense", category: "Staff & HR", code: "EC-905", description: "Training & Capacity Building" },
  { type: "Expense", category: "Staff & HR", code: "EC-906", description: "Staff Meals / Refreshments" },
  { type: "Expense", category: "Staff & HR", code: "EC-907", description: "Office Uniforms & PPE" },
  { type: "Expense", category: "Staff & HR", code: "EC-908", description: "Wages (Casual Labour)" },
  { type: "Expense", category: "Staff & HR", code: "EC-909", description: "Travel Allowance / Per Diem" },
